...
def respuesta():
    ...
    return bottle.template('respuesta',equipos=equipos, puntos= puntos,pganados=pganados, 
           pempate= pempate,pperdidos=pperdidos,golesfavor=golesfavor,golescontra=golescontra,
           promedio=promedio)
...
def respuesta():
    ...
    return bottle.template('respuestaresul',
                           ronda=ronda,
                           local=local,
                           visitor=visitor,
                           date_partido=date_partido,
                           hour=hour,
                           minute=minute,
